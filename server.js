...
async function go() {
  let client = new MongoClient("mongodb+srv://samratankalkote:yUf3wTnf7POJRobs@cluster0.dnhmop2.mongodb.net/TodoApp?retryWrites=true&w=majority")
...
function passwordProtected(req, res, next){
   ...
   if(req.headers.authorization == "Basic bGVhcm46YWxsc2V0dG9yaXNl") {
    next()
   } 
   else{
...
/*  This is the deleted code from <ul> </ul> tags.
